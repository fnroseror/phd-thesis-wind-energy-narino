# Final Author–Year References — Article 01 Energy Reports
...
This file contains the depurated reference list selected for Article 01.

The purpose is to move from the broad verified candidate list to a final, compact and journal-suitable reference set.

The reference strategy is:

```text
Use only references that support the problem, method, physical interpretation, regional context, data source or reproducibility.
```

---

# 2. Final reference decision

Initial verified candidate references:
...
# 3. Final selected reference IDs

The following references enter the final manuscript:

```text
R01, R02, R03, R04,
R07, R08, R09, R10, R11, R13,
R14, R15, R16, R17, R19,
R20, R23, R24,
...
# 4. Final references — Author–year style
...
# 5. Reserve references

The following references remain in reserve.
...
# 6. Reserve-reference rationale

## R05 and R06

Useful for broader Latin American and South American wind-energy context, but not essential for the first submitted version.

## R12 and R13 decision

R13 remains in the final list because it helps acknowledge Weibull limitations.  
R12 remains in reserve to avoid overloading the distributional discussion.

## R18

Useful for mountainous CFD context, but R14, R15, R16, R17 and R19 already cover complex terrain strongly.

## R21, R22 and R25

Useful for detailed air-density discussion, standards or turbine-performance correction.  
They remain in reserve because Article 01 is not a turbine-performance paper.

## R31

Useful as a forecasting review.  
It remains in reserve because Article 01 is not a forecasting article.

## R35 and R38

Useful for additional spectral discussion.  
They remain in reserve because R33, R34, R36 and R37 already support the FFT/spectral block.

## R40 and R41

Useful for Colombian policy background.  
They remain in reserve because the article should not become a policy paper.

## R44

Useful for regional renewable-energy context in Nariño.  
It remains in reserve because it is photovoltaic, not wind-energy specific.

## R46 and R47

Useful for official data context.  
They remain in reserve because R45 is enough for the main IDEAM data-access citation.

## R50 and R51

Useful for reproducibility best practices.  
They remain in reserve because R48 and R49 are sufficient for the main reproducibility argument.

---

# 7. Manuscript insertion map
...
Gil Ruiz et al. (2022)
IDEAM and UPME (2006)
Eraso Checa and Escobar Rosero (2018)
Palma et al. (2008)
Carvalho et al. (2013)
```
...
WPD as stronger descriptor than wind speed
Colombia/Nariño context
complex-terrain challenge
need for zone-level characterization
```
...
Colombian wind-energy context
direct Nariño precedent
```

---

## Methodology — WPD and air density
...
air-density relevance
physical basis of WPD estimation
```

---

## Methodology — Weibull and Rayleigh
...
wind-speed distributional analysis
```

---

## Methodology — ACF/PACF
...
Brown et al. (1984)
Torres et al. (2005)
Kavasseri and Seetharaman (2009)
Erdem and Shi (2011)
```
...
FFT method
wind spectrum
period-band interpretation
spectral analysis in wind-resource studies
```
...
Use citations minimally.

Recommended citations only where needed:
...
```text
interpretation of distributional fit
caution about Weibull generalization
temporal persistence interpretation
spectral-energy interpretation
```
...
```text
complex terrain interpretation
air-density importance
Weibull limitations
temporal persistence
spectral structure
Andean wind-resource relevance
```
...
# 8. Citation-control checklist

Before final submission, verify:

```text
Every in-text citation appears in final reference list.
Every reference in final list appears in the manuscript.
DOI corresponds to exact article.
No IEEE numeric citation remains.
No uncited references remain.
No duplicated references remain.
No reserve references accidentally enter the final list.
```

---

# 9. TDQ reference rule

A final reference must support at least one of these:
...
If it does not support one of these, it remains in reserve.
...
Final reference count: 34
Reserve references defined: yes
Author-year style drafted: yes
Manuscript insertion map: drafted
In-text citation insertion: pending
Final reference cross-check: pending
```
