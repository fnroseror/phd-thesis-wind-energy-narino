...
This manuscript is positioned as a physical–statistical wind-energy characterization study based on WPD, observed meteorological data, air-density-supported estimation, distributional fitting, temporal memory and FFT-based spectral analysis.

It should not be presented as a turbine-level feasibility study, wind-farm investment assessment, micrositing study, CFD simulation, or forecasting-model validation paper.
