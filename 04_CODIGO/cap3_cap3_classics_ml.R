# ============================================================
# CAP3 – Classical + ML (Base/Bayes) Pipeline (Eh target)
# PURPOSE: Classical models + ML (RF/XGB) with export of predictions for hybrid TDQ
# INPUTS: Clean dataset (e.g., Datos.txt) and configured output folders
# OUTPUTS: Metrics tables + figures + prediction cache vectors
